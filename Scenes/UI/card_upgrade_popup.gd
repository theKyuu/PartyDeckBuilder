...
func show_tooltip(origin_card: Card) -> void:
	...
	origin_card_ui.tooltip_requested.connect(hide_tooltip.unbind(1))
	...
	upgrade_card_ui.tooltip_requested.connect(hide_tooltip.unbind(1))
