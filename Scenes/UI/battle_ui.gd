...
func initialize_card_pile_ui() -> void:
	draw_pile_button.card_pile = team_stats.draw_pile
	draw_pile_view.card_pile = team_stats.draw_pile
	discard_pile_button.card_pile = team_stats.discard
	discard_pile_view.card_pile = team_stats.discard
